...
//        }
//        do{
//            data.db = try Connection("db.sqlite3")
//            print(data.db.description)
//       
...
//        do { // 创建表TABLE_LAMP
//            try data.db.run(TABLE_CHARACTER.create { table in
...
//        var num: Int = 0
//        do{
//            let obj = try data.db.prepare(query)
//            num = Array(obj).count
//        }
//        catch{}
//        if(num > 0){
...
//            do {
//                let rowid = try data.db.run(insert)
...
//        
//        do{
//            let all = Array(try data.db.prepare(TABLE_CHARACTER))
//        print("We have \(all.count) items in database.")
//            for item in (try! data.db.prepare(TABLE_CHARACTER)) {
...
//        do{
//            try data.db.run(TABLE_CHARACTER.delete())
