...
//    func colorAt(x: Int, y: Int, img: CGImage) -> [CGFloat] {
...
//    func createBitmapContext(img: CIImage) -> CGContext {
//        // Get image width, height
//        let pixelsWide = img.extent.width
//        let pixelsHigh = img.extent.height
//        let bitmapBytesPerRow = pixelsWide * 4
...
//        // draw the image onto the context
//        let rect = CGRect(x: 0, y: 0, width: pixelsWide, height: pixelsHigh)
//        context?.draw(img.ToCGImage(), in: rect)
//        return context!
//    }
