...
class Utility: NSObject {
    ...
    func furigana(String:String, fontName: String, fontSize: CGFloat) -> NSMutableAttributedString {
        let attributed =
            String
        ...
        attributed.addAttributes([NSAttributedString.Key.font: NSFont(name: fontName, size: fontSize)!, NSAttributedString.Key.verticalGlyphForm: false,],range: NSMakeRange(0, (attributed.length)))
