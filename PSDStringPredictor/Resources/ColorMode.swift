...
class ColorModeInput : MLFeatureProvider {
...
@available(macOS 10.14, iOS 12.0, tvOS 12.0, *)
@available(watchOS, unavailable)
class ColorModeOutput : MLFeatureProvider {
...
class ColorMode {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "ColorMode", withExtension:"mlmodelc")!
    }

    /**
        Construct ColorMode instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of ColorMode.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `ColorMode.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct ColorMode instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct ColorMode instance asynchronously with optional configuration.
...
//    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as ColorModeInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as ColorModeOutput
    */
    func prediction(input: ColorModeInput) throws -> ColorModeOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as ColorModeOutput
    */
    func prediction(input: ColorModeInput, options: MLPredictionOptions) throws -> ColorModeOutput {
        let outFeatures = try model.prediction(from: input, options:options)
        return ColorModeOutput(features: outFeatures)
    }
    ...
    /**
        ...
        - returns: the result of the prediction as ColorModeOutput
    */
    func prediction(image: CVPixelBuffer) throws -> ColorModeOutput {
        let input_ = ColorModeInput(image: image)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [ColorModeInput]
           - options: prediction options 
        ...
        - returns: the result of the prediction as [ColorModeOutput]
    */
    func predictions(inputs: [ColorModeInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [ColorModeOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [ColorModeOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  ColorModeOutput(features: outProvider)
